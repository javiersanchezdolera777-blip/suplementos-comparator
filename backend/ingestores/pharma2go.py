...
def clasificar_producto(nombre: str, desc_limpia: str):
    ...
    basura = [
        ...
        "spray", "nasal", "ocular", "gotas", "colirio", "crema hidratante", "perro", "perros", "gato", "gatos", "mascota", "mascotas"
    ...
    if c["categoria"] == CategoriaEnum.proteinas.value:
        # 1. Primero determinamos el TIPO de proteína
        ...
        # 2. Intentamos extraer el porcentaje exacto llamando a la función matemática
