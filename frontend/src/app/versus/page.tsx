  ...
  if (compareIds.length === 0) {
    return (
      <div className="min-h-[80vh] bg-gray-50 flex flex-col items-center justify-center p-6 text-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 mb-4 flex items-center justify-center gap-2 flex-wrap sm:flex-nowrap">Comparativa de Especificaciones</h1>
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8 flex flex-col">
      <div className="max-w-[1400px] mx-auto w-full flex-1 flex flex-col justify-center py-4">
        <div className="mb-6 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 flex items-center gap-2 whitespace-nowrap">Comparativa de Especificaciones</h1>
          </div>
            ...
            <div className="w-full overflow-x-auto pb-4 scrollbar-thin rounded-2xl">
              <div className="min-w-max md:min-w-full">
                      ...
                      <div key={prod.id} className="flex-1 p-3 md:p-5 border-l border-gray-200 flex flex-col relative group min-w-[160px] sm:min-w-[200px] md:min-w-0">
                        ...
                        <div className="mt-1 md:mt-2 flex flex-col">
                          ...
                          <Link
                            ...
                            className="mt-3 flex items-center justify-center gap-1 text-[10px] md:text-xs font-bold text-slate-700 bg-white border border-slate-300 hover:bg-slate-50 hover:text-slate-900 py-1.5 px-3 rounded-lg transition-all shadow-sm w-full"
                          >
                            Ficha técnica <span aria-hidden="true">&rarr;</span>
                          </Link>
                        </div>
                      </div>
                    );
                ...
                {hasFormat && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">Formato</span>
                    </div>
                    {productos.map(prod => (
                      <div key={prod.id} className="flex-1 py-3 md:py-3.5 px-3 md:px-4 border-r border-gray-100 flex items-center justify-center text-center last:border-r-0 min-w-[160px] sm:min-w-[200px] md:min-w-0">
                        <span className="text-xs md:text-sm font-semibold text-slate-900 capitalize truncate" title={prod.format || prod.formato || '-'}>
                ...
                {hasPresentation && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">Tamaño / Cantidad</span>
                    </div>
                    {productos.map(prod => (
                      <div key={prod.id} className="flex-1 py-3 md:py-3.5 px-3 md:px-4 border-r border-gray-100 flex items-center justify-center text-center last:border-r-0 min-w-[160px] sm:min-w-[200px] md:min-w-0">
                        <span className="text-xs md:text-sm font-semibold text-slate-900 capitalize truncate" title={prod.presentacion || '-'}>
                          {prod.presentacion || '-'}
                        </span>
                      </div>
                    ))}
                ...
                {hasFlavors && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">Sabores</span>
                    </div>
                    {productos.map(prod => {
                      ...
                      return (
                        <div key={prod.id} className="flex-1 py-3 md:py-3.5 px-3 md:px-4 border-r border-gray-100 flex items-center justify-center text-center last:border-r-0 min-w-[160px] sm:min-w-[200px] md:min-w-0">
                          <span className="text-[11px] md:text-xs font-semibold text-slate-900 line-clamp-2" title={display}>
                            {display}
                          </span>
                        </div>
                      );
                ...
                {hasDiet && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">Dieta / Alérgenos</span>
                    </div>
                    {productos.map(prod => {
                      const tags = [];
                      ...
                      return (
                        <div key={prod.id} className="flex-1 py-3 md:py-3.5 px-3 md:px-4 border-r border-gray-100 flex items-center justify-center text-center last:border-r-0 min-w-[160px] sm:min-w-[200px] md:min-w-0">
                          <span className={`text-[11px] md:text-xs font-semibold line-clamp-2 ${tags.length > 0 ? 'text-emerald-700' : 'text-slate-900'}`} title={label}>
                            {label}
                          </span>
                        </div>
                      );
                ...
                {hasQualitySeal && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">Sello de calidad</span>
                    </div>
                    {productos.map(prod => (
                      <div key={prod.id} className="flex-1 py-3 md:py-3.5 px-3 md:px-4 border-r border-gray-100 flex items-center justify-center text-center last:border-r-0 min-w-[160px] sm:min-w-[200px] md:min-w-0">
                        <span className="text-[11px] md:text-xs font-semibold text-slate-900 truncate" title={prod.quality_seal || prod.sello_calidad || '-'}>
                ...
                {hasProteinPercentage && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">% Proteína</span>
                    </div>
                    {productos.map(prod => {
                ...
                {hasSpecificProfile && (
                  <div className="flex border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div className="w-28 md:w-40 py-3 md:py-3.5 px-3 md:px-4 shrink-0 border-r border-gray-100 flex items-center">
                      <span className="text-xs md:text-sm font-bold text-slate-800">Perfil Específico</span>
                    </div>
                    {productos.map(prod => {
                      let perfilStr = '-';
                      ...
                      return (
                        <div key={prod.id} className="flex-1 py-3 md:py-3.5 px-3 md:px-4 border-r border-gray-100 flex items-center justify-center text-center last:border-r-0 min-w-[160px] sm:min-w-[200px] md:min-w-0">
                          {perfilStr !== '-' ? (
                            <span className="text-[11px] md:text-xs font-semibold text-blue-700 bg-blue-50 px-2 py-1 rounded truncate max-w-full" title={perfilStr}>
                              {perfilStr}
                            </span>
                          ) : (
                            <span className="text-xs md:text-sm font-semibold text-slate-900">-</span>
                          )}
                        </div>
                      );
                    })}
