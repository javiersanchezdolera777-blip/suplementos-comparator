    ...
    <div className="flex flex-col min-h-screen bg-[#090d16] font-sans text-white relative selection:bg-white/20">
      ...
      <main className="flex-1 flex flex-col items-center z-10 w-full max-w-7xl mx-auto px-6 pt-2 pb-6">
        <section className="w-full flex flex-col items-center justify-center text-center mt-4 md:mt-6 mb-6 md:mb-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter max-w-4xl leading-[1.1] mb-4 drop-shadow-xl">
          ...
          <p className="text-sm md:text-base text-slate-400/90 max-w-2xl mb-8 leading-relaxed font-medium">
          ...
          {/* Partner Grid */}
          <div className="w-full max-w-5xl mx-auto mb-8 pt-6 border-t border-white/10">
            <p className="text-[10px] font-bold tracking-widest text-slate-500 uppercase mb-6">Comparamos en tiempo real el catálogo de</p>
