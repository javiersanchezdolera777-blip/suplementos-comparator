      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-16 md:py-24 relative z-10">
        ...
        <div className="space-y-8 text-slate-400 text-sm leading-relaxed">
          <section>
            ...
            <p>
              En cumplimiento con el deber de información recogido en artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico, a continuación se reflejan los siguientes datos: la plataforma web Tus Suplementos (en adelante, "la Plataforma") es operada de forma independiente y es de acceso libre.
              <br /><br />
              <strong>Contacto:</strong> hola@tussuplementos.com
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              La información contenida en Tus Suplementos, incluyendo textos, gráficos, imágenes y otros materiales, tiene fines puramente informativos y comparativos. Ningún contenido de esta web pretende ser un sustituto de asesoramiento médico profesional, diagnóstico o tratamiento.
          ...
          <section>
            ...
            <p>
              Tus Suplementos contiene enlaces que dirigen a sitios web de terceros. Operamos bajo el modelo de Afiliación (CPA). Esto exime a Tus Suplementos de cualquier responsabilidad sobre las transacciones, envíos, devoluciones o reclamaciones que deban gestionarse directamente con el vendedor final.
            </p>
          </section>
        </div>
      </main>
