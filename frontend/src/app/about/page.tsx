  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#030712] font-sans text-white selection:bg-white/20">
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-16 md:py-24 relative z-10">
        ...
        <p className="text-xl text-slate-400 font-medium mb-12">La misión detrás de Tus Suplementos.</p>
        ...
        <div className="space-y-8 text-slate-300 leading-relaxed font-medium">
          <section>
            ...
            <p>
              Tus Suplementos nació con una misión muy clara: aportar <strong>transparencia y ahorro</strong> al mundo de la suplementación deportiva en España.
          ...
          <section>
            ...
            <p>
              Hemos desarrollado un motor de búsqueda propio que se conecta a los catálogos de las principales marcas del país: <em>Myprotein, HSN, Bulk, Prozis, etc</em>.
          ...
          <section className="p-8 rounded-3xl bg-white/5 border border-white/10 mt-12">
            ...
            <p className="text-slate-400">
              Queremos ser 100% transparentes contigo. Tus Suplementos es y siempre será una herramienta gratuita. Para mantener los servidores y seguir mejorando la plataforma, participamos en programas de afiliación.
