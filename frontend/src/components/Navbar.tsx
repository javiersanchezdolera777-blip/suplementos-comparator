      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
        ...
        {isLoggedIn ? (
          <div className="flex items-center gap-4">
            <Link 
              href="/favoritos"
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 hover:bg-red-100 border border-red-100 text-red-600 transition-all hover:scale-105 active:scale-95 shadow-sm"
            >
              ...
              {favoriteIds && favoriteIds.length > 0 && (
                <span className="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full font-black min-w-[20px] text-center shadow-sm">
                  {favoriteIds.length}
                </span>
              )}
            </Link>
            <button 
              onClick={logout}
              className="flex items-center gap-2 px-5 py-2 rounded-full bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 transition-all hover:scale-105 active:scale-95 shadow-sm"
            >
          ...
          <div className="relative group">
            <button 
              ...
              className="flex items-center gap-2 px-5 py-2 rounded-full bg-slate-900 hover:bg-slate-800 text-white transition-all hover:scale-105 active:scale-95 shadow-md shadow-slate-900/10"
            >
